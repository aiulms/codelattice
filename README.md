...
CodeLattice 用 Rust 编写，当前 beta 支持 Rust、Cangjie / 仓颉、ArkTS、TypeScript、C、C++、Python 七条本地图谱分析路径，并提供 CLI 与 MCP sidecar 两种使用方式。当前 master 暴露 37 个 MCP 工具，已经从“图谱查询”扩展到死代码候选、影响面分析、风险热点、架构偏移、可达性、公开 API 风险、框架入口提示、文档/测试/配置一致性审查和 AI 工作流预设。
...
> **状态：** Phase B — Graph Visualization + Snapshot Diff 已落地（不是完整 WebUI）
