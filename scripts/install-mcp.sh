...
JSON
    ...
    echo "  - 50 tools including facade tools, graph diagnostics, review gates, workflow presets, automation graph, workspace graph, cross-project impact, root-cause evidence assistant, and process-local cache"
