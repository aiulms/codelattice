...
`--doctor` 检查：binary、开发 wrapper、stable wrapper 状态、MCP handshake、tools/list (>= 37)、cache_status、language support profile、fixture-level smoke。
