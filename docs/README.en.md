...
Current release status: **External Beta (`v0.13.0-beta.1`)**. Rust and Cangjie are the stable language lines; ArkTS / HarmonyOS is in production trial; TypeScript is in Phase A.
